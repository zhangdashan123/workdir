...
if __name__ == '__main__':
    mp = MatPlotLib()
    total_list = [[['2019/9/19', '2019/9/20', '2019/9/21', '2019/9/22', '2019/9/23'], [1540, 1940, 4890, 1390, 1390], '康莱德套房', 'r'], [['2019/9/19', '2019/9/20', '2019/9/21', '2019/9/22', '2019/9/23'], [1440, 1390, 1640, 2890, 1940], '皇冠豪华房', 'g'], [['2019/9/19', '2019/9/20', '2019/9/21', '2019/9/22', '2019/9/23'], [534, 614, 774, 934, 1120], '皇冠高级房', 'b']]
