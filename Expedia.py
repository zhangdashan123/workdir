...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(170, 160, 141, 31))
        font = QtGui.QFont()
        ...
        self.pushButton.setGeometry(QtCore.QRect(380, 160, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(530, 160, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.comboBox.setGeometry(QtCore.QRect(80, 260, 131, 31))
        font = QtGui.QFont()
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(300, 260, 131, 31))
        font = QtGui.QFont()
        font.setFamily("Agency FB")
        font.setPointSize(12)
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(520, 260, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(14)
        font.setBold(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "抓取城市:"))
        self.lineEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p align=\"center\">此处输入抓取程序</p></body></html>"))
        ...
        self.pushButton_3.setText(_translate("MainWindow", "生成折线图"))
